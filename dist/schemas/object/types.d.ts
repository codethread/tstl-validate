/** @noSelfInFile */
import type { Input, Output, ResolveObject } from '../../types';
import type { ObjectShape } from './object';
import type { ObjectShapeAsync } from './objectAsync';
/**
 ...
 */
export type ObjectInput<TObjectShape extends ObjectShape | ObjectShapeAsync> = ResolveObject<WithQuestionMarks<{
    [TKey in keyof TObjectShape]: Input<TObjectShape[TKey]>;
}>>;
/**
 * Object output inference type.
 */
export type ObjectOutput<TObjectShape extends ObjectShape | ObjectShapeAsync> = ResolveObject<WithQuestionMarks<{
